...
- Developed next-generation AI features for Broadcom products (ICE, Clarity), building MCP-based services with RAG to query and summarize data across up to 500K enterprise records
